...
The group I was working with were dedicated and friendly, as were all the people I met there, in fact.[^11] Between the four of us we represented five universities (including {% include person.html name="Hao-Ting Wang" twitter="HaoTingW713" website="https://wanghaoting.com/" %} who joined the [Sackler Centre](http://www.sussex.ac.uk/sackler/) in Sussex after I left!), and the project lead, {% include person.html name="Danielle Kurtin" orcid="0000-0001-5368-6737" website="https://www.imperial.ac.uk/people/danielle.kurtin18" %}, made the programming task fairly straightforward by having designed the experiment to the minutest detail. As with every project proposed, the initial aims were wildly optimistic (we completed three quaters of one bullet point), but we did produce a working demo of the task in the time allowed.[^12]
